...
and audit trails---running in production at Massachusetts General Hospital
and freely available under the Apache-2.0 license.
\end{abstract}
...
REST API endpoints across 14 route modules, and a React frontend. The
...
Lab Manager fills a persistent gap in laboratory informatics: the
conversion of paper supply documents into structured, queryable data.
LIMS and ELN systems provide mature data management infrastructure but
assume that data arrives in structured form. Lab Manager automates the
upstream step of \emph{document understanding}---turning scanned packing
lists, invoices, and certificates of analysis into database records that
feed directly into inventory, ordering, and analytics workflows.
