...
Supplementary Materials include: (1)~per-document extraction results for
all 4 VLMs across all 23 evaluated fields; (2)~item-level extraction
accuracy (catalog numbers, lot numbers, quantities); (3)~consensus
pipeline end-to-end accuracy on a held-out document set; (4)~OCR
comparison across 5 OCR engines on 8 documents; (5)~the complete
extraction prompt used for all VLM evaluations; and (6)~example
human review sessions with consensus metadata.
