...
def upgrade() -> None:
    ...
    sa.Column('extraction_model', sqlmodel.sql.sqltypes.AutoString(length=100), nullable=True),
    ...
    sa.Column('created_by', sqlmodel.sql.sqltypes.AutoString(length=100), nullable=True),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('catalog_number', sqlmodel.sql.sqltypes.AutoString(length=100), nullable=False),
    ...
    sa.Column('catalog_number', sqlmodel.sql.sqltypes.AutoString(length=100), nullable=True),
    ...
    op.create_index(op.f('ix_order_items_catalog_number'), 'order_items', ['catalog_number'], unique=False)
