...
export function ErrorBanner({ error, onDismiss }: ErrorBannerProps) {
  ...
  return (
    <div className="fixed top-4 left-0 right-0 mx-auto max-w-md z-50 flex items-center gap-3 p-3 rounded-lg border border-[var(--destructive)]/30 bg-[var(--destructive)]/10">
