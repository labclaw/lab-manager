...
For `v0.1.9`, the release gate is the maintained core suite plus `scripts/run_release_gate.sh`. The older BDD backlog is still part of product cleanup, but it is not the authoritative release decision.
