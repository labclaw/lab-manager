...
[![Version](https://img.shields.io/badge/version-0.1.10-green.svg)](https://github.com/labclaw/lab-manager/releases)
...
`v0.1.10` is the current stable internal release. The maintained backend, database model, setup wizard, login flow, review queue, inventory lifecycle, export, search, and admin surface are validated on the release-critical suite and real-user smoke flows.
...
`v0.1.10` is release-gated by an explicit maintained suite, not by the full historical test tree.
