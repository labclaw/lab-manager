...
@router.get("/{product_id}/pubchem", dependencies=[Depends(require_permission("view_inventory"))])
...
@router.post("/{product_id}/enrich", response_model=ProductResponse, dependencies=[Depends(require_permission("manage_products"))])
